...
onconnect = function (e) {
	for (const port of e.ports) {
		port.onmessage = async event => {
			...
			switch (msg.type) {
				case "message":
					const { add } = await __webpack_require__.e(/*! import() */ 936).then(() => (__webpack_require__(/*! ./chat-module */ 4)));
					add(msg.content, msg.from);
				// fallthrough
				case "history":
					const { history } = await __webpack_require__.e(/*! import() */ 936).then(() => (__webpack_require__(/*! ./chat-module */ 4)));
					port.postMessage({
						type: "history",
						history
					});
...
```javascript
var e={};const t={};function o(s){const r=t[s];if(void 0!==r)return r.exports;const n=t[s]={exports:{}};return e[s](n,n.exports,o),n.exports}o.m=e,o.d=(e,t)=>{if(Array.isArray(t))for(var s=0;s<t.length;){var r=t[s++],n=t[s++],a=0===n?{enumerable:!0,value:t[s++]}:{enumerable:!0,get:n};o.o(e,r)||Object.defineProperty(e,r,a)}else for(var r in t)o.o(t,r)&&!o.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},o.f={},o.e=e=>Promise.all(Object.keys(o.f).reduce((t,s)=>(o.f[s](e,t),t),[])),o.o=(e,t)=>Object.hasOwn(e,t),(()=>{const e={936:()=>import("/dist/936.js")},t={377:0},s=e=>{let{__webpack_esm_ids__:s,__webpack_esm_modules__:r,__webpack_esm_runtime__:n}=e;var a,i,c=0;for(a in r)o.o(r,a)&&(o.m[a]=r[a]);for(n&&n(o);c<s.length;c++)i=s[c],o.o(t,i)&&t[i]&&t[i][0](),t[i]=0};o.f.j=(r,n)=>{let a=o.o(t,r)?t[r]:void 0;if(0!==a)if(a)n.push(a[1]);else{let o=e[r]().then(s,e=>{throw 0!==t[r]&&(t[r]=void 0),e});o=Promise.race([o,new Promise(e=>a=t[r]=[e])]),n.push(a[1]=o)}}})(),onconnect=function(e){for(const t of e.ports)t.onmessage=async e=>{const s=e.data;switch(s.type){case"message":const{add:e}=await o.e(936).then(()=>o(936));e(s.content,s.from);case"history":const{history:r}=await o.e(936).then(()=>o(936));t.postMessage({type:"history",history:r})}}};
```
...
```javascript
var e={};const o={};function s(t){const r=o[t];if(void 0!==r)return r.exports;const n=o[t]={exports:{}};return e[t](n,n.exports,s),n.exports}s.m=e,s.d=(e,o)=>{for(var t in o)s.o(o,t)&&!s.o(e,t)&&Object.defineProperty(e,t,{enumerable:!0,get:o[t]})},s.f={},s.e=e=>Promise.all(Object.keys(s.f).reduce((o,t)=>(s.f[t](e,o),o),[])),s.o=(e,o)=>Object.hasOwn(e,o),(()=>{const e={129:()=>import("/dist/129.js")},o={721:0},t=e=>{let{__webpack_esm_ids__:t,__webpack_esm_modules__:r,__webpack_esm_runtime__:n}=e;var i,a,_=0;for(i in r)s.o(r,i)&&(s.m[i]=r[i]);for(n&&n(s);_<t.length;_++)a=t[_],s.o(o,a)&&o[a]&&o[a][0](),o[a]=0};s.f.j=(r,n)=>{let i=s.o(o,r)?o[r]:void 0;if(0!==i)if(i)n.push(i[1]);else{let s=e[r]().then(t,e=>{throw 0!==o[r]&&(o[r]=void 0),e});s=Promise.race([s,new Promise(e=>i=o[r]=[e])]),n.push(i[1]=s)}}})(),onmessage=async e=>{const{fibonacci:o}=await s.e(129).then(()=>s(129)),t=JSON.parse(e.data);postMessage(`fib(${t}) = ${o(t)}`)};
```
...
```
asset main.js 7.86 KiB [emitted] [javascript module] (name: main)
asset chat.js 6.08 KiB [emitted] [javascript module] (name: chat)
asset workers/fibonacci.js 5.74 KiB [emitted] [javascript module] (name: fibonacci)
...
chunk (runtime: 1fad8bf8de78b0a77bfd) chat.js (chat) 442 bytes (javascript) 2.85 KiB (runtime) [entry] [rendered]
  > ./example.js 25:19-31:1
  runtime modules 2.85 KiB 5 modules
  ./chat-worker.js 442 bytes [built] [code generated]
    [used exports unknown]
    new Worker() ./chat-worker.js ./example.js 25:19-31:1
chunk (runtime: 9a81d90cfd0dfd13d748) workers/fibonacci.js (fibonacci) 176 bytes (javascript) 2.85 KiB (runtime) [entry] [rendered]
  > ./example.js 80:18-84:2
  runtime modules 2.85 KiB 5 modules
  ./fib-worker.js 176 bytes [built] [code generated]
    [used exports unknown]
    new Worker() ./fib-worker.js ./example.js 80:18-84:2
chunk (runtime: main) main.js (main) 2.25 KiB (javascript) 2.85 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 2.85 KiB 5 modules
...
```
asset main.js 2.31 KiB [emitted] [javascript module] [minimized] (name: main)
asset chat.js 1.24 KiB [emitted] [javascript module] [minimized] (name: chat)
asset workers/fibonacci.js 942 bytes [emitted] [javascript module] [minimized] (name: fibonacci)
...
chunk (runtime: 9a81d90cfd0dfd13d748, main) 129.js 103 bytes [rendered]
  ...
  ./fibonacci.js 103 bytes [built] [code generated]
    ...
    import() ./fibonacci ./example.js 70:30-51
    import() ./fibonacci ./fib-worker.js 2:29-50
chunk (runtime: 1fad8bf8de78b0a77bfd) chat.js (chat) 442 bytes (javascript) 3.01 KiB (runtime) [entry] [rendered]
  > ./example.js 25:19-31:1
  runtime modules 3.01 KiB 4 modules
  ./chat-worker.js 442 bytes [built] [code generated]
    [no exports used]
    new Worker() ./chat-worker.js ./example.js 25:19-31:1
chunk (runtime: 9a81d90cfd0dfd13d748) workers/fibonacci.js (fibonacci) 176 bytes (javascript) 2.64 KiB (runtime) [entry] [rendered]
  > ./example.js 80:18-84:2
  runtime modules 2.64 KiB 4 modules
  ./fib-worker.js 176 bytes [built] [code generated]
    [no exports used]
    new Worker() ./fib-worker.js ./example.js 80:18-84:2
chunk (runtime: main) main.js (main) 2.25 KiB (javascript) 2.64 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 2.64 KiB 4 modules
  ./example.js 2.25 KiB [built] [code generated]
    [no exports used]
